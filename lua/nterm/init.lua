...
vim.keymap.set('x', '<leader>s', '<Plug>SlimeRegionSend', { noremap = false, silent = true })
vim.keymap.set('n', '<leader>s', '<Plug>SlimeMotionSend', { noremap = false, silent = true })
vim.keymap.set('n', '<leader>ss', '<Plug>SlimeLineSend', { noremap = false, silent = true })
